...
def parse_option():
    ...
    parser.add_argument('--phase', type=str, default='cls', choices=['base', 'cmc', 'cls', 'base'])
    ...
    # specify folder
    parser.add_argument('--data_folder', type=str, default='/users/b146466/xifan/NTU_RGBD_60_avi', help='path to data')
